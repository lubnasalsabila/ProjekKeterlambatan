...
<body>
    <div id="back-wrap" style="top: 10%;">
        <button class="btn btn-secondary"><a href="{{ route('terlambat.admin.keterlambatan.rekap') }}" class="btn-back" style="color: aliceblue; text-decoration: none; top:">Kembali</a></button>
    </div>
    <div class="card">
        <div class="card-body">
            <div id="pdf">
                <a href="{{ route('terlambat.admin.keterlambatan.download',$lates['id']) }}" class="btn-print" onclick="setTanggal()">Cetak (.pdf)</a>
                <center id="top">
                    <div class="info">
